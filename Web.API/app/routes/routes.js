...
const WebAnalytics = require('../controllers/WebAnalytics');
...
// Analytics Routes
router.get('/analytics', WebAnalytics.getTimeSpentOnPage);
router.get('/analytics/bouton_send', WebAnalytics.getNumberOfTimeSendMessageBtn);
